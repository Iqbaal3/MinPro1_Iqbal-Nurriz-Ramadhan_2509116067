...
# FlowChart dan penjelasan alur program
**Berikut FlowChart dari Program "Pelacak Asupan Kalori& Protein Harian" :**

<img width="1627" height="2049" alt="Image" src="https://github.com/user-attachments/assets/92682502-9872-4b29-bfcc-3205b2dda8f0" />
...
8. Jika Perintah adalah/bernilai "Hapus" maka akan masuk ke tampilan menu hapus yaitu : 
...
9) Jika perintah bernilai "Tambah" maka program akan masuk ke tampilan menu tambah
...
**1. Jika Memilih Selesai sebelum menambah makanan**
<img width="1366" height="768" alt="Image" src="https://github.com/user-attachments/assets/7e2cb5d6-425e-4d01-8a43-4ede10dd401b" />

**2. Jika Memilih Hapus sebelum menambah makanan**
<img width="1366" height="768" alt="Image" src="https://github.com/user-attachments/assets/ec008acc-719c-4c86-953d-f24e62edace5" />

**3. Jika Memilih List sebelum menambah makanan**
<img width="1366" height="768" alt="Image" src="https://github.com/user-attachments/assets/aa9d72a4-d4ee-47cd-8368-02b86c16cc56" />

**4. Jika Menambah makanan namun berat tidak valid **
<img width="1366" height="768" alt="Image" src="https://github.com/user-attachments/assets/258cf588-20c1-400e-8439-d2501939bd91" />

**5. Jika Menambah Makanan (Berhasil)**
<img width="1366" height="768" alt="Image" src="https://github.com/user-attachments/assets/3209f4aa-8a44-42e6-b2dc-2b70bd43aaa4" />

**6. Jika Memilih List setelah menambah makanan (Berhasil)**
<img width="1366" height="768" alt="Image" src="https://github.com/user-attachments/assets/c44ab2d9-9e4b-4be0-ae00-803b3e67c6aa" />

**7. Jika Memilih Hapus setelah menambah makanan namun nomor yang diinput tidak valid**
<img width="1366" height="768" alt="Image" src="https://github.com/user-attachments/assets/abd725d8-6a08-4be6-8942-1fcde7bf658f" />

**8. Jika Memilihh Hapus setelah menambah makanan (Berhasil)**
<img width="1366" height="768" alt="Image" src="https://github.com/user-attachments/assets/d2bca5eb-42a2-4208-bcef-03690160154d" />

**9. Jika Memilih Selesai setelah menambah makanan (Berhasil)**
<img width="1366" height="768" alt="Image" src="https://github.com/user-attachments/assets/d63a4e5d-c231-4659-bca8-004022f02836" />
